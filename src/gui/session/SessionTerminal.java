...
public class SessionTerminal extends Terminal implements Activatable, CommandListener {
	...
	private static final Command ctrlCommand = new Command( "CTRL", Command.ITEM, 22 );

	private static final Command altCommand = new Command( "ALT", Command.ITEM, 23 );
	...
	private static final Command[] commandsNormal = new Command[] {
			textInputCommand, cursorCommand, scrollCommand, tabCommand, ctrlCommand, altCommand, enterCommand,
			disconnectCommand
	};

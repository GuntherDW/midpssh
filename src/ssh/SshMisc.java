...
public class SshMisc {
	...
	static public byte getNotZeroRandomByte() {
		...
		String randomString = String.valueOf(SshIO.rnd.nextLong()
				* date.getTime()); // RADEK date.GetTime() * Math.random()
	 ...
	 * computed.
	 */
	static private long crc32_tab[] = { 0x00000000L, 0x77073096L, 0xee0e612cL,
